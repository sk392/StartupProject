...
$result_array = array();
$jwt_error='0';
if(!empty($sktoken) &&!empty($reservation_id)&&(!empty($coupon_id) ||$coupon_id==0)&&!empty($origin_cost)&&!empty($finally_cost)&&!empty($payment_date)){
  ...
  $query = "INSERT INTO payment(userinfo_id,coupon_id,reservation_id,origin_cost,finally_cost,payment_date) values('$user_id','$coupon_id','$reservation_id','$origin_cost','$finally_cost','$payment_date')" ; //list
